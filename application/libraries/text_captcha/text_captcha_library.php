...
namespace app\libraries\text_captcha;

class Text_Captcha_Library {
    
    public function generate_text_captcha() {
        ...
        $captcha_text[100]['question'] = 'How many letters in "jilting"?';
        $captcha_text[100]['answer'] = '7';
        
        $captcha_text[101]['question'] = 'Out of a truck, a lion, the color purple, and the number forty-two, which has a door?';
        $captcha_text[101]['answer'] = 'truck';
        
        $captcha_text[102]['question'] = 'Thirty seven, 1, 40, 4 and six: the 4th number is?';
        $captcha_text[102]['answer'] = '4';
        
        $captcha_text[103]['question'] = 'Twelve minus 6 = ?';
        $captcha_text[103]['answer'] = '6';
        
        $captcha_text[104]['question'] = 'What is eighteen minus 3?';
        $captcha_text[104]['answer'] = '15';
...
// End of file: ./application/libraries/text_captcha/text_capthca_library.php