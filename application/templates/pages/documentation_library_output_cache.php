...
<p>
You can also specify the TTL (the time it takes before the cache expires) at the time of storing data in the cache. The default experiation time is 3600 seconds. For example, you can set it as 60 seconds.
</p>
