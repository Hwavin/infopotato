...
<form id="contact_form" method="post" action="<?php echo APP_URI_BASE; ?>contact/" accept-charset="utf-8">  
<div>
...
<div class="form_item">
<input type="submit" name="submit_btn" class="uibutton confirm" id="submit_btn" value="Send" />  
</div>
