...
<li class="current_tab"><a href="<?php echo APP_URI_BASE; ?>about/index/facts/" title="<?php echo __('Facts'); ?>"><?php echo __('Facts'); ?></a></li> 
...
<!-- begin breadcrumb -->
<div id="breadcrumb">
<h1 class="first_heading"><?php echo __('Facts about InfoPotato'); ?></h1>	
