...
<div id="toc"> 
<ul> 
<li class="current_tab"><a href="<?php echo BASE_URI; ?>about/" title="Motivation">Motivation</a></li>
...
<p>
For a long time, I thought InfoPotato was an MVC framework and I was trying to follow the MVC architectural pattern. But one day, I read a book called "Building PHP Applications with Symfony, CakePHP, and Zend Framework", and in this book, the author memtioned that many so-called PHP MVC frameworks are not real MVC, and the truth is many of them are following the MVP architectural pattern. Afterthat, I did more reading and I found my InfoPotato was MVP indeed. And I realized that I don't need an MVC framework for the web, and trying to find one will make me feel like I'm trying to fit a square peg into a round hole. What we really need is to look at a very simple request-response handling framework. So from that monment, I rewrote InfoPotato and got rid off either MVC or MVP. InfoPotato now, is only a simple web development framework that handles request and response.
</p>
