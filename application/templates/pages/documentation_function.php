...
<!-- begin breadcrumb -->
<div id="breadcrumb">
<h1 class="first_heading"><?php echo __('Function Reference'); ?></h1> 
<a href="<?php echo APP_URI_BASE; ?>home"><?php echo __('Home'); ?></a> &gt; <a href="<?php echo APP_URI_BASE; ?>documentation/"><?php echo __('Documentation'); ?></a> &gt; Function Reference
</div>
<!-- end breadcrumb -->

<h2><?php echo __('Function Reference'); ?></h2> 
<ul> 
