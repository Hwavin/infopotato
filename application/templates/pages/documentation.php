...
<div class="fourcol">
<div class="greybox">	
<h3 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/start/">Getting Started</a></h3> 
</div>
...
<div class="fourcol">
<div class="greybox">
<h3 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/intro/">Introduction</a></h3> 
</div>
...
<div class="greybox">
<h3 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/core/">Core Topics</a></h3>
</div>
...
<div class="fourcol">
<div class="greybox">	
<h3 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/library/">Libraries</a></h3>
</div>
</div>

<div class="fourcol">
<div class="greybox">
<h3 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/function/">Functions</a></h3>  
</div>
</div>

<div class="fourcol last">
<div class="greybox">
<h3 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/tutorial/">Tutorials</a></h3>
</div>
</div>
