...
<h2 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/start/">Getting Started</a></h2> 
</div>


<div class="doc_category">
<h2 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/intro/">Introduction</a></h2> 
</div>


<div class="doc_category">
<h2 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/core/">Core Topics</a></h2>
</div>


<div class="doc_category">	
<h2 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/library/">Libraries</a></h2>
</div>

<div class="doc_category">
<h2 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/function/">Functions</a></h2>  
</div>

<div class="doc_category">
<h2 class="center"><a href="<?php echo APP_URI_BASE; ?>documentation/tutorial/">Tutorials</a></h2>
</div>
