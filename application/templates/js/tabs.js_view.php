...
Tabs = {
    ...
    GoTo: function (contentId, skipReplace) {
        ...
        for (var i = 0; i < divs.length; i++) {
            ...
            if (div.className.match(/\btab_content\b/i)) {
...
if (document.createStyleSheet) {
    ...
    style.addRule("div.tab_content", "display: none;");
    ...
    if (head) {
        ...
        style.appendChild(document.createTextNode("div.tab_content { display: none; }"));
