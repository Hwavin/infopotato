...
#column1 ul {
list-style:disc url('<?php echo STATIC_URI_BASE; ?>application/images/shared/arrow.gif');
}
...
list-style:disc inside url('<?php echo STATIC_URI_BASE; ?>application/images/shared/bullet.gif');
}
