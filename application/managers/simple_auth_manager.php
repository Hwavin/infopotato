...
class Simple_Auth_Manager extends Manager {
    ...
    public function post_login() {
        $username = isset($this->_POST_DATA['username']) ? trim($this->_POST_DATA['username']) : '';
        $password = isset($this->_POST_DATA['password']) ? trim($this->_POST_DATA['password']) : '';
        $auto_login = isset($this->_POST_DATA['auto_login']) ? $this->_POST_DATA['auto_login'] : '';
        ...
        if ($this->_identify($username, $password) === TRUE) {
            ...
            \InfoPotato\functions\redirect\redirect_function($this->_get_requested_uri(TRUE, APP_URI_BASE.'agreement/'));
        } else {
            $content_data = array(
                'auth' => FALSE, 
            );
    ...
    public function get_logout() {
        ...
        $this->load_function('SYS', 'redirect/redirect_function');
        // Namespace is used at beginning
        \InfoPotato\functions\redirect\redirect_function(APP_URI_BASE.'home/');
    }
