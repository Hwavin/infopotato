...
class Mobile_Detect_Library {
    ...
    /**
     * Overloads is_android() | is_blackberry() | is_opera() | is_palm() | is_windows() | is_generic() through is_device()
     *
     * @param string $name
    ...
    protected function is_device($device) {
