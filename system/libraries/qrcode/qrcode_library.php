...
class QRcode_Library {
     ...
     * @var string
     */
    private $qrcode_error_correct = 'M';
     ...
     * @var integer
     */
    private $qrcode_structureappend_n = 3;
     ...
     * @var integer
     */
    private $qrcode_structureappend_m = 4;
     ...
     * @var string
     */
    private $qrcode_structureappend_originaldata = 'dasdsa';
    ...
    /**
     * Validate and set $version_ul
     *
     * @param  $val int
     * @return void
     */
    private function initialize_version_ul($val) {
        if ( ! is_int($val)) {
            $this->invalid_argument_value('version_ul');
        }
        $this->version_ul = $val;
    }
    
    /**
     * Validate and set $qrcode_error_correct
     *
     * @param  $val string
     * @return void
     */
    private function initialize_qrcode_error_correct($val) {
        if ( ! is_string($val)) {
            $this->invalid_argument_value('qrcode_error_correct');
        }
        $this->qrcode_error_correct = $val;
    }
    
    /**
     * Validate and set $qrcode_module_size
     *
     * @param  $val string
     * @return void
     */
    private function initialize_qrcode_module_size($val) {
        if ( ! is_int($val)) {
            $this->invalid_argument_value('qrcode_module_size');
        }
        $this->qrcode_module_size = $val;
    }
    ...
    /**
     * Validate and set $qrcode_image_type
     *
     * @param  $val string
     * @return void
     */
    private function initialize_qrcode_image_type($val) {
        if ( ! is_string($val)) {
            $this->invalid_argument_value('qrcode_image_type');
        }
        $this->qrcode_image_type = $val;
    }
    
    /**
     * Validate and set $qrcode_structureappend_n
     *
     * @param  $val int
     * @return void
     */
    private function initialize_qrcode_structureappend_n($val) {
        if ( ! is_int($val)) {
            $this->invalid_argument_value('qrcode_structureappend_n');
        }
        $this->qrcode_structureappend_n = $val;
    }
    
    /**
     * Validate and set $qrcode_structureappend_m
     *
     * @param  $val string
     * @return void
     */
    private function initialize_qrcode_structureappend_m($val) {
        if ( ! is_string($val)) {
            $this->invalid_argument_value('qrcode_structureappend_m');
        }
        $this->qrcode_structureappend_m = $val;
    }
    ...
    public function main($str) {
        ...
        if ($this->qrcode_structureappend_n > 1
         && $this->qrcode_structureappend_n <= 16
         && $this->qrcode_structureappend_m > 0
         && $this->qrcode_structureappend_m <= 16) {
        ...
        */
        ...
        $qrcode_image_size = $mib*$this->qrcode_module_size;
