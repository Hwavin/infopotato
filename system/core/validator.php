...
class Validator {
     ...
     * @return    bool
     */
    public static function valid_date($str, $format = NULL) {
        ...
        $dateFromFormat = DateTime::createFromFormat($format, $str);

        return $dateFromFormat && $str === date($format, $dateFromFormat->getTimestamp());
    }
