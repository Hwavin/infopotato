...
class MySQLi_Adapter {
	...
	/**
	 * @var boolean Whether to show SQL/DB errors defined in error_messages
	 */
	...
	public function connect($dbuser = '', $dbpass = '', $dbhost = 'localhost') {
		...
		} elseif ( ! $this->dbh = new mysqli($dbhost, $dbuser, $dbpass)) {
	...
	public function select($dbname = '') {
		...
		elseif ( ! $this->dbh->select_db($dbname)) {
	 ...
	 * Even so, the full results will be cached should you wish to use them with another query.
	 *
