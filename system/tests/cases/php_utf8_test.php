...
class PHP_UTF8_Test extends PHPUnit_Framework_TestCase {
    ...
    public function test_strlen_utf8() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals(20, PHP_UTF8::strlen($str));
    }
    ...
    public function test_strlen_ascii() {
        $str = 'ABC 123';
        $this->assertEquals(7, PHP_UTF8::strlen($str));
    }

    // Test strlen()
    public function test_strlen_empty_str() {
        $str = '';
        $this->assertEquals(0, PHP_UTF8::strlen($str));
    }
    ...
    public function test_strpos_utf8() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals(6, PHP_UTF8::strpos($str, 'â'));
    }

    // Test strpos()
    public function test_strpos_utf8_offset() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals(19, PHP_UTF8::strpos($str, 'n', 11));
    }

    // Test strpos()
    public function test_strpos_utf8_invalid() {
        $str = "Iñtërnâtiôn\xe9àlizætiøn";
        $this->assertEquals(15, PHP_UTF8::strpos($str, 'æ'));
    }

    // Test strpos()
    public function test_strpos_ascii() {
        $str = 'ABC 123';
        $this->assertEquals(1, PHP_UTF8::strpos($str, 'B'));
    }

    // Test strpos()
    public function test_strpos_vs_strpos() {
        $str = 'ABC 123 ABC';
        $this->assertEquals(strpos($str, 'B', 3), PHP_UTF8::strpos($str, 'B', 3));
    }

    // Test strpos()
    public function test_strpos_empty_str() {
        $str = '';
        $this->assertFalse(PHP_UTF8::strpos($str, 'x'));
    }

    // Test strrpos()
    public function test_strrpos_utf8() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals(17, PHP_UTF8::strrpos($str, 'i'));
    }

    // Test strrpos()
    public function test_strrpos_utf8_offset() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals(19, PHP_UTF8::strrpos($str, 'n', 11));
    }

    // Test strrpos()
    public function test_strrpos_utf8_invalid() {
        $str = "Iñtërnâtiôn\xe9àlizætiøn";
        $this->assertEquals(15, PHP_UTF8::strrpos($str, 'æ'));
    }

    // Test strrpos()
    public function test_strrpos_ascii() {
        $str = 'ABC ABC';
        $this->assertEquals(5, PHP_UTF8::strrpos($str, 'B'));
    }

    // Test strrpos()
    public function test_strrpos_vs_strpos() {
        $str = 'ABC 123 ABC';
        $this->assertEquals(strrpos($str, 'B'), PHP_UTF8::strrpos($str, 'B'));
    }

    // Test strrpos()
    public function test_strrpos_empty_str() {
        $str = '';
        $this->assertFalse(PHP_UTF8::strrpos($str, 'x'));
    }
    ...
    public function test_strrpos_linefeed_search() {
        $str = "Iñtërnâtiônàlizætiø\nn";
        $this->assertEquals(19, PHP_UTF8::strrpos($str, "\n"));
    }
    ...
    public function test_substr_utf8() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals('Iñ', PHP_UTF8::substr($str, 0, 2));
    }

    // Test substr()
    public function test_substr_utf8_two() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals('të', PHP_UTF8::substr($str, 2, 2));
    }

    // Test substr()
    public function test_substr_utf8_zero() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals('Iñtërnâtiônàlizætiøn', PHP_UTF8::substr($str, 0));
    }

    // Test substr()
    public function test_substr_utf8_zero_zero() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals('', PHP_UTF8::substr($str, 0, 0));
    }

    // Test substr()
    public function test_substr_start_great_than_length() {
        $str = 'Iñt';
        $this->assertEmpty(PHP_UTF8::substr($str, 4));
    }

    // Test substr()
    public function test_substr_compare_start_great_than_length() {
        $str = 'abc';
        $this->assertEquals(substr($str, 4), PHP_UTF8::substr($str, 4));
    }

    // Test substr()
    public function test_substr_length_beyond_string() {
        $str = 'Iñt';
        $this->assertEquals('ñt', PHP_UTF8::substr($str, 1, 5));
    }

    // Test substr()
    public function test_substr_compare_length_beyond_string() {
        $str = 'abc';
        $this->assertEquals(substr($str, 1, 5), PHP_UTF8::substr($str, 1, 5));
    }

    // Test substr()
    public function test_substr_start_negative() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals('tiøn', PHP_UTF8::substr($str, -4));
    }

    // Test substr()
    public function test_substr_length_negative() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals('nàlizæti', PHP_UTF8::substr($str, 10, -2));
    }

    // Test substr()
    public function test_substr_start_length_negative() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals('ti', PHP_UTF8::substr($str, -4, -2));
    }

    // Test substr()
    public function test_substr_linefeed() {
        $str = "Iñ\ntërnâtiônàlizætiøn";
        $this->assertEquals("ñ\ntër", PHP_UTF8::substr($str, 1, 5));
    }

    // Test substr()
    public function test_substr_long_length() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals('Iñtërnâtiônàlizætiøn', PHP_UTF8::substr($str, 0, 15536));
    }
    ...
    public function test_strtolower() {
        ...
        $this->assertEquals($lower, PHP_UTF8::strtolower($str));
    }
    ...
    public function test_strtoupper() {
        ...
        $this->assertEquals($upper, PHP_UTF8::strtoupper($str));
    }
    ...
    public function test_ucword() {
        ...
        $this->assertEquals($ucwords, PHP_UTF8::ucwords($str));
    }
    ...
    public function test_wordwrap_long_break() {
        $line = PHP_UTF8::wordwrap("Ä very<br>long wöö<br>öööööööö<br>öörd.", 8, '<br>', FALSE);
    ...
    public function test_wordwrap_cut_beginning_single_space() {
        $line = PHP_UTF8::wordwrap(' äüöäöü', 3, ' ', TRUE);
    ...
    public function test_wordwrap_cut_ending_single_space_with_non_space_divider() {
        $line = PHP_UTF8::wordwrap('äöüäöü ', 3, '-', TRUE);
    ...
    public function test_wordwrap_no_cut_ending_single_space() {
        $line = PHP_UTF8::wordwrap('12345 ', 5, '-', FALSE);
    ...
    public function test_ucfirst() {
        ...
        $this->assertEquals($ucfirst, PHP_UTF8::ucfirst($str));
    }
    ...
    public function test_ucfirst_empty_string() {
        $str = '';
        $this->assertEquals('', PHP_UTF8::ucfirst($str));
    }
    ...
    public function test_rtrim() {
        ...
        $this->assertEquals($trimmed, PHP_UTF8::rtrim($str, 'ø'));
    }
    ...
    public function test_rtrim_empty_string() {
        $str = '';
        $trimmed = '';
        $this->assertEquals($trimmed, PHP_UTF8::rtrim($str));
    }
    ...
    public function test_ltrim() {
        ...
        $this->assertEquals($trimmed, PHP_UTF8::ltrim($str, 'ñ'));
    }
    ...
    public function test_ltrim_empty_string() {
        $str = '';
        $trimmed = '';
        $this->assertEquals($trimmed, PHP_UTF8::ltrim($str));
    }
    ...
    public function test_ltrim_negate_char_class() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $trimmed = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals($trimmed, PHP_UTF8::ltrim($str, '^s'));
    }
    ...
    public function test_trim() {
        ...
        $this->assertEquals($trimmed, PHP_UTF8::trim($str, 'ñø'));
    }
    ...
    public function test_trim_empty_string() {
        $str = '';
        $trimmed = '';
        $this->assertEquals($trimmed, PHP_UTF8::trim($str));
    }
    ...
    public function test_substr_replace_replace_start() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $replaced = 'IñtërnâtX';
        $this->assertEquals($replaced, PHP_UTF8::substr_replace($str, 'X', 8));
    }
    ...
    public function test_substr_replace_negative() {
        ...
        $this->assertEquals($replaced, PHP_UTF8::substr_replace($str, 'foo', -2, -2));
    }
    ...
    public function test_substr_replace_zero() {
        ...
        $this->assertEquals($replaced, PHP_UTF8::substr_replace($str, 'foo', 0, 0));
    }
    ...
    public function test_substr_replace_linefeed() {
        $str = "Iñ\ntërnâtiônàlizætiøn";
        $replaced = "Iñ\ntërnâtX";
        $this->assertEquals($replaced, PHP_UTF8::substr_replace($str, 'X', 9));
    }
    ...
    public function test_substr_replace_linefeed_replace() {
        $str = "Iñ\ntërnâtiônàlizætiøn";
        $replaced = "Iñ\ntërnâtX\nY";
        $this->assertEquals($replaced, PHP_UTF8::substr_replace($str, "X\nY", 9));
    }

    // Test strspn()
    public function test_strspn_match() {
        $str = 'iñtërnâtiônàlizætiøn';
        $this->assertEquals(11, PHP_UTF8::strspn($str, 'âëiônñrt'));
    }

    // Test strspn()
    public function test_strspnmatch_two() {
        $str = 'iñtërnâtiônàlizætiøn';
        $this->assertEquals(4, PHP_UTF8::strspn($str, 'iñtë'));
    }

    // Test strspn()
    public function test_strspncompare_strspn() {
        $str = 'aeioustr';
        $this->assertEquals(strspn($str, 'saeiou'), PHP_UTF8::strspn($str, 'saeiou'));
    }

    // Test strspn()
    public function test_strspnmatch_ascii() {
        $str = 'internationalization';
        $this->assertEquals(strspn($str, 'aeionrt'), PHP_UTF8::strspn($str, 'aeionrt'));
    }

    // Test strspn()
    public function test_strspnlinefeed() {
        $str = "iñtërnât\niônàlizætiøn";
        $this->assertEquals(8, PHP_UTF8::strspn($str, 'âëiônñrt'));
    }

    // Test strspn()
    public function test_strspnlinefeed_mask() {
        $str = "iñtërnât\niônàlizætiøn";
        $this->assertEquals(12, PHP_UTF8::strspn($str, "âëiônñrt\n"));
    }
    ...
    public function test_strrev() {
        ...
        $this->assertEquals($rev, PHP_UTF8::strrev($str));
    }
    ...
    public function test_stristr_substr() {
        $str = 'iñtërnâtiônàlizætiøn';
        $search = 'NÂT';
        $this->assertEquals('nâtiônàlizætiøn', PHP_UTF8::stristr($str, $search));
    }
    ...
    public function test_stristr_substr_no_match() {
        $str = 'iñtërnâtiônàlizætiøn';
        $search = 'foo';
        $this->assertFalse(PHP_UTF8::stristr($str, $search));
    }
    ...
    public function test_stristr_empty_search() {
        $str = 'iñtërnâtiônàlizætiøn';
        $search = '';
        $this->assertEquals('iñtërnâtiônàlizætiøn', PHP_UTF8::stristr($str, $search));
    }
    ...
    public function test_stristr_empty_both() {
        $str = '';
        $search = '';
        $this->assertEmpty(PHP_UTF8::stristr($str, $search));
    }
    ...
    public function test_stristr_linefeed_both() {
        $str = "iñtërn\nâtiônàlizætiøn";
        $search = "N\nÂT";
        $this->assertEquals("n\nâtiônàlizætiøn", PHP_UTF8::stristr($str, $search));
    }

    // Test strcspn()
    public function test_strcspn_no_match_single_byte_search() {
        $str = 'iñtërnâtiônàlizætiøn';
        $this->assertEquals(2, PHP_UTF8::strcspn($str, 't'));
    }

    // Test strcspn()
    public function test_strcspn_no_match_multi_byte_search() {
        $str = 'iñtërnâtiônàlizætiøn';
        $this->assertEquals(6, PHP_UTF8::strcspn($str, 'â'));
    }

    // Test strcspn()
    public function test_strcspn_compare_strspn() {
        $str = 'aeioustr';
        $this->assertEquals(strcspn($str, 'tr'), PHP_UTF8::strcspn($str, 'tr'));
    }

    // Test strcspn()
    public function test_strcspn_match_ascii() {
        $str = 'internationalization';
        $this->assertEquals(strcspn($str, 'a'), PHP_UTF8::strcspn($str, 'a'));
    }

    // Test strcspn()
    public function test_strcspn_linefeed() {
        $str = "i\nñtërnâtiônàlizætiøn";
        $this->assertEquals(3, PHP_UTF8::strcspn($str, 't'));
    }

    // Test strcspn()
    public function test_strcspn_linefeed_mask() {
        $str = "i\nñtërnâtiônàlizætiøn";
        $this->assertEquals(1, PHP_UTF8::strcspn($str, "\n"));
    }
    ...
    public function test_str_ireplace_replace() {
        ...
        $this->assertEquals($replaced, PHP_UTF8::str_ireplace('lIzÆ', 'lise', $str));
    }
    ...
    public function test_str_ireplace_replace_no_match() {
        ...
        $this->assertEquals($replaced, PHP_UTF8::str_ireplace('foo', 'bar', $str));
    }
    ...
    public function test_str_ireplace_empty_search() {
        $str = 'Iñtërnâtiônàlizætiøn';
        $replaced = 'Iñtërnâtiônàlizætiøn';
        $this->assertEquals($replaced, PHP_UTF8::str_ireplace('', 'x', $str));
    }
    ...
    public function test_str_ireplace_replace_count() {
        ...
        $this->assertEquals($replaced, PHP_UTF8::str_ireplace('n', 'X', $str, 2));
    }
    ...
    public function test_str_ireplace_replace_different_search_replace_length() {
        ...
        $this->assertEquals($replaced, PHP_UTF8::str_ireplace('n', 'XXX', $str));
    }
    ...
    public function test_str_ireplace_replace_array_ascii_search() {
        ...
        $this->assertEquals($replaced, PHP_UTF8::str_ireplace(array('n', 't'), array('x', 'y'), $str));
    }
    ...
    public function test_str_ireplace_replace_linefeed_search() {
        $str = "Iñtërnâtiônàli\nzætiøn";
        $replaced = "Iñtërnâtiônàlisetiøn";
        $this->assertEquals($replaced, PHP_UTF8::str_ireplace("lI\nzÆ", 'lise', $str));
    }
    ...
    public function test_str_split_split_one_char() {
        ...
        $this->assertEquals($array, PHP_UTF8::str_split($str));
    }
    ...
    public function test_str_split_split_five_chars() {
        ...
        $this->assertEquals($array, PHP_UTF8::str_split($str, 5));
    }
    ...
    public function test_str_split_split_six_chars() {
        ...
        $this->assertEquals($array, PHP_UTF8::str_split($str, 6));
    }
    ...
    public function test_str_split_split_long() {
        ...
        $this->assertEquals($array, PHP_UTF8::str_split($str, 40));
    }
    ...
    public function test_strcasecmp_compare_equal() {
        ...
        $this->assertEquals(0, PHP_UTF8::strcasecmp($str_x, $str_y));
    }
    ...
    public function test_strcasecmp_less() {
        ...
        $this->assertTrue(PHP_UTF8::strcasecmp($str_x, $str_y) < 0);
    }
    ...
    public function test_ord_empty_str() {
        $str = '';
        $this->assertEquals(0, PHP_UTF8::ord($str));
    }

    // Test ord()
    public function test_ord_ascii_char() {
        $str = 'a';
        $this->assertEquals(97, PHP_UTF8::ord($str));
    }

    // Test ord()
    public function test_ord_2_byte_char() {
        $str = 'ñ';
        $this->assertEquals(241, PHP_UTF8::ord($str));
    }

    // Test ord()
    public function test_ord_3_byte_char() {
        $str = '₧';
        $this->assertEquals(8359, PHP_UTF8::ord($str));
    }

    // Test ord()
    public function test_ord_4_byte_char() {
        $str = "\xf0\x90\x8c\xbc";
        $this->assertEquals(66364, PHP_UTF8::ord($str));
    }
