 ...
 *
 * By default, htmLawed will neither beautify HTML code by formatting it with indentations, etc., 
 * nor will it make it compact by removing un-needed white-space.(It does always properly white-space tag content.)
